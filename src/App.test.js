...
test("Multiple notes can be added", () => {
  ...
  expect(noteList.children[0].children[0]).toHaveTextContent("Study");
  expect(noteList.children[0].children[1]).toHaveTextContent("progress");
  expect(noteList.children[1].children[0]).toHaveTextContent("Movie");
...
test("Switching between buttons work", () => {
  ...
  expect(noteList.children[0].children[0]).toHaveTextContent("Study");
  expect(noteList.children[0].children[1]).toHaveTextContent("progress");
  expect(noteList.children[1].children[0]).toHaveTextContent("Cooking");
  expect(noteList.children[1].children[1]).toHaveTextContent("pending");
  expect(noteList.children[2].children[0]).toHaveTextContent("Movie");
  expect(noteList.children[2].children[1]).toHaveTextContent("active");
  expect(noteList.children[3].children[0]).toHaveTextContent("Fill form");
  expect(noteList.children[3].children[1]).toHaveTextContent("active");
  expect(noteList.children[4].children[0]).toHaveTextContent(
    "Stocks investing"
  );
  expect(noteList.children[4].children[1]).toHaveTextContent("completed");
  expect(noteList.children[5].children[0]).toHaveTextContent("Complete code");
  expect(noteList.children[5].children[1]).toHaveTextContent("completed");
